...
func TestParserFlagOptionFull(t *testing.T) {
	...
	assertNil(t,err);
	if option==nil { t.Error("option is nil")}
...
func TestGetFlagTypeEmpty(t *testing.T){
	...
	if (err==nil) {t.Error("No error thrown")}
...
func TestParseGlobalOption(t *testing.T){
	...
	if !processed {t.Error("Option wasn't processed")}
...
func TestParseGlobalSwitch(t *testing.T){
	...
	if !processed {t.Error("Switch wasn't processed")}
...
func TestParseCommand(t *testing.T){
	...
	if !proc {t.Error("Command wasn't processed")}
}
...
func TestParseInnerFlagCommand(t *testing.T){
	...
	if !proc {t.Error("Switch wasn't processed")}
	if shouldnt{t.Error("Confusion between global and command flag")}
}
